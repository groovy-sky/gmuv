...
| [extension manifest](/api/references/extension-manifest) | 404 |
| [Video: Enhancing VS Code extensions with GitHub Copilot](https://build.microsoft.com/sessions/57efc1aa-83c0-45c5-b8c3-ad095478bb0a?source=sessions) | 403 |
...
| URL | State |
| --- | --- |
| [GitLab CI documentation](https://docs.gitlab.com/ee/ci/variables/README.html#mask-a-cicd-variable) | 403 |
...
| [tune in here](https://www.microsoft.com/en-us/connectevent) | 0 |
...
| --- | --- |
| [@burkeholland](https://twitter.com/burkeholland) | 400 |
| [The Nurnberg Funnel - Designing Minimalist Instruction for Practical Computer Skill](https://mitpress.mit.edu/books/nurnberg-funnel) | 403 |
| [@burkeholland](https://twitter.com/burkeholland) | 400 |
...
* https://github.com/microsoft/vscode-docs/blob/main/docs/containers/debug-common.md

| URL | State |
| --- | --- |
| [VS Code documentation](/docs/nodejs/nodejs-debugging-configuration.md#launch-configuration-attributes) | 404 |
...
* https://github.com/microsoft/vscode-docs/blob/main/docs/copilot/copilot-customization.md

| URL | State |
| --- | --- |
| [design-system/Form.md](../docs/design-system/Form.md) | 404 |
| [index](../index.ts) | 404 |

* https://github.com/microsoft/vscode-docs/blob/main/docs/copilot/copilot-tips-and-tricks.md
...
| URL | State |
| --- | --- |
| [Extensions view context menu with Switch to Pre-Release Version option](images/faq/switch-to-pre-release.png) | 504 |
...
| --- | --- |
| [Visual Studio Code](/download) | 404 |
| [Debugging controls](images/cpp/debug-controls.png) | 504 |

* https://github.com/microsoft/vscode-docs/blob/main/docs/cpp/configure-intellisense.md

| URL | State |
| --- | --- |
| [schema reference](/docs/cpp/c-cpp-properties-schema-reference.md) | 504 |

* https://github.com/microsoft/vscode-docs/blob/main/docs/cpp/cpp-debug.md

| URL | State |
| --- | --- |
| [Multi-threaded process](images/cpp/threads.png) | 504 |
...
| URL | State |
| --- | --- |
| [User Settings](/docs/editor/settings) | 404 |
...
| [Secret Service API](https://www.gnu.org/software/emacs/manual/html_node/auth/Secret-Service-API.html) | 0 |
| [Secret Service API](https://www.gnu.org/software/emacs/manual/html_node/auth/Secret-Service-API.html) | 0 |

* https://github.com/microsoft/vscode-docs/blob/main/docs/editor/telemetry.md

| URL | State |
| --- | --- |
| [privacy statement](https://go.microsoft.com/fwlink/?LinkID=528096&clcid=0x409) | 403 |

* https://github.com/microsoft/vscode-docs/blob/main/docs/editor/themes.md

| URL | State |
| --- | --- |
| [Settings](/docs/editor/settings) | 404 |
...
* https://github.com/microsoft/vscode-docs/blob/main/docs/editor/workspaces/workspace-trust.md
...
| --- | --- |
| [Download](/download) | 404 |
| [Screenshot that shows Git blame information when hovering over the git blame item in the Status Bar.](images/1_97/scm-git-blame.png) | 404 |
...
* https://github.com/microsoft/vscode-docs/blob/main/docs/intelligentapps/promptbuilder.md

| URL | State |
| --- | --- |
| [OpenAI SDK](https://platform.openai.com/docs/libraries) | 403 |
...
| URL | State |
| --- | --- |
| [Launch configuration support for 'npm' and other tools](/docs/nodejs/nodejs-debugging-configuration.md#launch-configuration-support-for-npm-and-other-tools) | 404 |
...
* https://github.com/microsoft/vscode-docs/blob/main/docs/reference/default-settings.md
...
| URL | State |
| --- | --- |
| [ligatures](https://en.wikipedia.org/wiki/Ligature_(writing) | 404 |
...
| [settings file](/docs/getstarted/settings.md) | 404 |
...
| [your own keybindings](/docs/getstarted/keybindings.md) | 404 |
...
| [keybindings](/docs/getstarted/keybindings.md) | 404 |
...
| [Rahul Kadyan](https://marketplace.visualstudio.com/publishers/znck) | 503 |
...
| URL | State |
| --- | --- |
| [issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22February+2025+Recovery+1%22+) | 404 |
| [issues](https://github.com/microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22February+2025+Recovery+2%22+) | 404 |
| [experimental features](command:workbench.action.openSettings?%5B%22%40tag%3Aexperimental%20%40ext%3Agithub.copilot-chat%22%5D) | 0 |
| [preview features](command:workbench.action.openSettings?%5B%22%40tag%3Apreview%20%40ext%3Agithub.copilot-chat%22%5D) | 0 |

* https://github.com/microsoft/vscode-docs/blob/main/release-notes/v1_99.md

| URL | State |
| --- | --- |
| [Closed issues](https://github.com/Microsoft/vscode/issues?q=is%3Aissue+is%3Aclosed+milestone%3A%22March+2025%22) | 404 |

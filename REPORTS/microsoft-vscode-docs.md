...
* https://github.com/microsoft/vscode-docs/blob/main/docs/csharp/refactoring.md

| URL | State |
| --- | --- |
| [Convert tuple to `struct` options](images/refactoring/convert-tuple-to-struct.png) | 504 |
